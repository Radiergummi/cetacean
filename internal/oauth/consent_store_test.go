...
func consentServer(t *testing.T) (*Server, string) {
	...
	s := newTestServer(t)
	s.consent.Remember(keyFor(testSubject, testClientID, s.cfg.defaultIdentifier()), testFingerprint)
...
func TestRevocationClearsConsent(t *testing.T) {
	...
	if s.consent.Allows(keyFor(testSubject, testClientID, s.cfg.defaultIdentifier()), testFingerprint) {
...
func TestTheftResultNamesTheBurnedFamily(t *testing.T) {
	...
	want := keyFor(testSubject, testClientID, s.cfg.defaultIdentifier())
...
func TestDisabledConsentAlwaysPromptsThroughTheServer(t *testing.T) {
	...
	s.consent.Restore([]ConsentRecord{{
		ConsentKey:  keyFor(testSubject, clientID, s.cfg.defaultIdentifier()),
...
func TestApprovedClientSkipsTheConsentPage(t *testing.T) {
	s, clientID, redirectURI, meta := cimdServer(t)
	s.consent.Remember(keyFor(testSubject, clientID, s.cfg.defaultIdentifier()), consentFingerprint(meta))
...
func TestChangedMetadataRePrompts(t *testing.T) {
	...
	s.consent.Remember(keyFor(testSubject, clientID, s.cfg.defaultIdentifier()), "fingerprint-from-before")
...
func TestDynamicallyRegisteredClientNeverSkipsTheConsentPage(t *testing.T) {
	...
	s.consent.Remember(keyFor(testSubject, clientID, s.cfg.defaultIdentifier()), fingerprint)
...
func TestApprovingThroughTheConsentPageIsRemembered(t *testing.T) {
	...
	approval := keyFor(testSubject, clientID, s.cfg.defaultIdentifier())
...
func TestMetadataChangedMidFlowRePrompts(t *testing.T) {
	...
	approval := keyFor(testSubject, documentURL, s.cfg.defaultIdentifier())
