...
func TestHandleServiceLogs_JSON(t *testing.T) {
	...
	h := NewHandlers(c, nil, &mockLogStreamer{data: frames.Bytes()}, nil, closedReady(), nil)
...
func TestHandleServiceLogs_JSON_NotFound(t *testing.T) {
	c := cache.New(nil)
	h := NewHandlers(c, nil, &mockLogStreamer{}, nil, closedReady(), nil)
...
func TestHandleServiceLogs_JSON_Empty(t *testing.T) {
	...
	h := NewHandlers(c, nil, &mockLogStreamer{data: nil}, nil, closedReady(), nil)
...
func TestHandleServiceLogs_SSE_LastEventID(t *testing.T) {
	...
	h := NewHandlers(c, nil, mock, nil, closedReady(), nil)
