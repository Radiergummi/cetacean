...
var errorRegistry = map[string]ErrorDef{
	...
	"API003": {Code: "API003", Title: "Not Acceptable", Status: http.StatusNotAcceptable,
		...
		Suggestion:  "Use Accept: application/json, text/event-stream, or text/html."},
	"API004": {Code: "API004", Title: "Invalid Patch Content-Type", Status: http.StatusUnsupportedMediaType,
	...
	"API005": {Code: "API005", Title: "Streaming Not Supported", Status: http.StatusInternalServerError,
	...
	"API009": {Code: "API009", Title: "Internal Serialization Error", Status: http.StatusInternalServerError,
	...
	"API010": {Code: "API010", Title: "Patch Test Failed", Status: http.StatusConflict,
	...
	// ── OPS: operations level ─────────────────────────────────────────
	"OPS001": {Code: "OPS001", Title: "Operations Level Too Low", Status: http.StatusForbidden,
	...
	// ── MTR: metrics / Prometheus ─────────────────────────────────────
	"MTR001": {Code: "MTR001", Title: "Prometheus Not Configured", Status: http.StatusServiceUnavailable,
	...
	"MTR005": {Code: "MTR005", Title: "Too Many Metrics Streams", Status: http.StatusTooManyRequests,
	...
	"MTR007": {Code: "MTR007", Title: "Prometheus Request Failed", Status: http.StatusInternalServerError,
	...
	"LOG004": {Code: "LOG004", Title: "Invalid Before Parameter", Status: http.StatusBadRequest,
		...
		Suggestion:  "Use a format like 2024-01-01T00:00:00Z or 1h30m."},
	"LOG005": {Code: "LOG005", Title: "Before Not Supported For SSE", Status: http.StatusBadRequest,
	...
	"LOG006": {Code: "LOG006", Title: "Log Retrieval Failed", Status: http.StatusInternalServerError,
	...
	"LOG007": {Code: "LOG007", Title: "Log Parse Failed", Status: http.StatusInternalServerError,
		...
		Suggestion:  "This is a server-side error. Check the Cetacean logs for details."},
	"LOG008": {Code: "LOG008", Title: "Log Stream Failed", Status: http.StatusInternalServerError,
		Description: "Failed to open the log stream from the Docker Engine.",
		Suggestion:  "Check that the service or task still exists and the Docker Engine is reachable."},

	// ── SSE: SSE connections ──────────────────────────────────────────
	"SSE001": {Code: "SSE001", Title: "Too Many SSE Connections", Status: http.StatusTooManyRequests,
	...
	// ── ENG: Docker Engine ────────────────────────────────────────────
	"ENG001": {Code: "ENG001", Title: "Docker Engine Unavailable", Status: http.StatusServiceUnavailable,
	...
	"ENG002": {Code: "ENG002", Title: "Docker Version Check Failed", Status: http.StatusServiceUnavailable,
	...
	// ── SWM: swarm operations ─────────────────────────────────────────
	"SWM001": {Code: "SWM001", Title: "Swarm API Not Available", Status: http.StatusNotImplemented,
	...
	"SWM002": {Code: "SWM002", Title: "Swarm Inspect Failed", Status: http.StatusServiceUnavailable,
	...
	"SWM004": {Code: "SWM004", Title: "Disk Usage Not Available", Status: http.StatusNotImplemented,
	...
	"SWM006": {Code: "SWM006", Title: "Token Rotation Failed", Status: http.StatusInternalServerError,
		Description: "Failed to rotate the swarm join token.",
		Suggestion:  "Check the Docker daemon logs for details."},
	"SWM007": {Code: "SWM007", Title: "Unlock Key Rotation Failed", Status: http.StatusInternalServerError,
	...
	"SWM009": {Code: "SWM009", Title: "Unlock Key Retrieval Failed", Status: http.StatusInternalServerError,
	...
	"PLG003": {Code: "PLG003", Title: "Plugin Privilege Check Failed", Status: http.StatusInternalServerError,
		Description: "Failed to check the required privileges for the plugin.",
		Suggestion:  "Check the Docker daemon logs for details."},

	// ── NOD: node operations ──────────────────────────────────────────
	"NOD001": {Code: "NOD001", Title: "Node Not Down", Status: http.StatusConflict,
	...
	"NOD002": {Code: "NOD002", Title: "Node Version Conflict", Status: http.StatusConflict,
	...
	// ── SVC: service operations ───────────────────────────────────────
	"SVC001": {Code: "SVC001", Title: "Service Version Conflict", Status: http.StatusConflict,
	...
	"SVC002": {Code: "SVC002", Title: "Service In Use", Status: http.StatusConflict,
	...
	"SVC005": {Code: "SVC005", Title: "Cannot Scale Global Service", Status: http.StatusBadRequest,
	...
	"SVC007": {Code: "SVC007", Title: "No Previous Spec", Status: http.StatusBadRequest,
	...
	"SVC009": {Code: "SVC009", Title: "Replicas Required For Replicated Mode", Status: http.StatusBadRequest,
	...
	"SVC011": {Code: "SVC011", Title: "Invalid Resource Specification", Status: http.StatusBadRequest,
	...
	"SVC015": {Code: "SVC015", Title: "Config Missing Required Fields", Status: http.StatusBadRequest,
	...
	"SVC016": {Code: "SVC016", Title: "Secret Missing Required Fields", Status: http.StatusBadRequest,
	...
	"SVC018": {Code: "SVC018", Title: "Invalid Patch Result", Status: http.StatusBadRequest,
		...
		Suggestion:  "Check the patch operations for correctness."},
	"SVC019": {Code: "SVC019", Title: "Invalid Log Driver Specification", Status: http.StatusBadRequest,
	...
	// ── TSK: task operations ──────────────────────────────────────────
	"TSK001": {Code: "TSK001", Title: "Task Already Removed", Status: http.StatusConflict,
	...
	"TSK002": {Code: "TSK002", Title: "Task Not Found", Status: http.StatusNotFound,
	...
	// ── STK: stack operations ─────────────────────────────────────────
	"STK001": {Code: "STK001", Title: "Stack Not Found", Status: http.StatusNotFound,
	...
	// ── VOL: volume operations ────────────────────────────────────────
	"VOL001": {Code: "VOL001", Title: "Volume In Use", Status: http.StatusConflict,
	...
	// ── NET: network operations ───────────────────────────────────────
	"NET001": {Code: "NET001", Title: "Network Has Active Endpoints", Status: http.StatusConflict,
	...
	// ── CFG: config operations ────────────────────────────────────────
	"CFG001": {Code: "CFG001", Title: "Config In Use", Status: http.StatusConflict,
	...
	// ── SEC: secret operations ────────────────────────────────────────
	"SEC001": {Code: "SEC001", Title: "Secret In Use", Status: http.StatusConflict,
