...
function promqlFunction(label: string, detail: string): Suggestion {
...
const promqlFunctions: Suggestion[] = [
  promqlFunction("abs", "abs(v instant-vector)"),
  promqlFunction("absent", "absent(v instant-vector)"),
  promqlFunction("avg_over_time", "avg_over_time(v range-vector)"),
  promqlFunction("ceil", "ceil(v instant-vector)"),
  promqlFunction("changes", "changes(v range-vector)"),
  promqlFunction("clamp", "clamp(v instant-vector, min, max scalar)"),
  promqlFunction("count_over_time", "count_over_time(v range-vector)"),
  promqlFunction("delta", "delta(v range-vector)"),
  promqlFunction("deriv", "deriv(v range-vector)"),
  promqlFunction("exp", "exp(v instant-vector)"),
  promqlFunction("floor", "floor(v instant-vector)"),
  promqlFunction("histogram_quantile", "histogram_quantile(phi scalar, b instant-vector)"),
  promqlFunction("idelta", "idelta(v range-vector)"),
  promqlFunction("increase", "increase(v range-vector)"),
  promqlFunction("irate", "irate(v range-vector)"),
  promqlFunction("label_join", "label_join(v instant-vector, dst, sep, ...src)"),
  promqlFunction("label_replace", "label_replace(v instant-vector, dst, replacement, src, regex)"),
  promqlFunction("ln", "ln(v instant-vector)"),
  promqlFunction("log2", "log2(v instant-vector)"),
  promqlFunction("log10", "log10(v instant-vector)"),
  promqlFunction("max_over_time", "max_over_time(v range-vector)"),
  promqlFunction("min_over_time", "min_over_time(v range-vector)"),
  promqlFunction("predict_linear", "predict_linear(v range-vector, t scalar)"),
  promqlFunction("rate", "rate(v range-vector)"),
  promqlFunction("resets", "resets(v range-vector)"),
  promqlFunction("round", "round(v instant-vector, to_nearest scalar)"),
  promqlFunction("scalar", "scalar(v instant-vector)"),
  promqlFunction("sort", "sort(v instant-vector)"),
  promqlFunction("sort_desc", "sort_desc(v instant-vector)"),
  promqlFunction("sqrt", "sqrt(v instant-vector)"),
  promqlFunction("stddev_over_time", "stddev_over_time(v range-vector)"),
  promqlFunction("sum_over_time", "sum_over_time(v range-vector)"),
  promqlFunction("time", "time()"),
  promqlFunction("timestamp", "timestamp(v instant-vector)"),
  promqlFunction("vector", "vector(s scalar)"),
  promqlFunction("year", "year(v instant-vector)"),
  promqlFunction("month", "month(v instant-vector)"),
  promqlFunction("day_of_month", "day_of_month(v instant-vector)"),
  promqlFunction("day_of_week", "day_of_week(v instant-vector)"),
  promqlFunction("day_of_year", "day_of_year(v instant-vector)"),
  promqlFunction("days_in_month", "days_in_month(v instant-vector)"),
  promqlFunction("hour", "hour(v instant-vector)"),
  promqlFunction("minute", "minute(v instant-vector)"),
  // Aggregation operators
  promqlFunction("avg", "avg(v instant-vector)"),
  promqlFunction("count", "count(v instant-vector)"),
  promqlFunction("group", "group(v instant-vector)"),
  promqlFunction("max", "max(v instant-vector)"),
  promqlFunction("min", "min(v instant-vector)"),
  promqlFunction("stddev", "stddev(v instant-vector)"),
  promqlFunction("stdvar", "stdvar(v instant-vector)"),
  promqlFunction("sum", "sum(v instant-vector)"),
  promqlFunction("topk", "topk(k scalar, v instant-vector)"),
  promqlFunction("bottomk", "bottomk(k scalar, v instant-vector)"),
  promqlFunction("count_values", 'count_values("label", v instant-vector)'),
  promqlFunction("quantile", "quantile(phi scalar, v instant-vector)"),
];
