  ...
  return (
    <div className={`relative w-full ${className}`}>
      ...
      <input
        ...
        className="w-full rounded-md border bg-background py-2 pe-8 ps-9 text-sm outline-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50"
      />
