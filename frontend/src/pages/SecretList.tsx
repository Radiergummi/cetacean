...
export default function SecretList() {
    ...
    return (
        <div>
            ...
            <ListToolbar search={search} onSearchChange={setSearch} placeholder="Search secrets…" viewMode={viewMode} onViewModeChange={setViewMode}/>
                    ...
                    {secrets.map(({CreatedAt, ID, Spec: {Name}, UpdatedAt}) => (
                        ...
                        >
                            <div className="flex flex-col gap-1 text-xs text-muted-foreground">
                                <span>
                                    Created: {CreatedAt ? <TimeAgo date={CreatedAt}/> : "\u2014"}
                                </span>
                                <span>
                                    Updated: {UpdatedAt ? <TimeAgo date={UpdatedAt}/> : "\u2014"}
                                </span>
                            </div>
                        </ResourceCard>
                    ))}
