...
Cetacean recognises four Swarm ecosystem tools from a service's own labels, and renders each as a structured
panel on the service [detail page][detail-pages], above the labels section. Nothing is rendered when no matching
labels are present.
