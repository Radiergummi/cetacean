...
cluster through the Docker socket and keeps the page current on its own—there's nothing to poll and nothing to
refresh.
...
| [Configuration][configuration]       | Command-line flags, environment variables, TOML file, operations level |
