...
- [ ] Removed endpoints `/topology/networks` and `/topology/placement` return 404 (the SPA fallback serves HTML for a browser Accept, JSON clients get a problem response)
